                                                                      ...
                                                                      <td class="esd-container-frame" width="550" valign="top" align="center">
                                                                          <table width="100%" cellspacing="0" cellpadding="0">
                                                                              <tbody>
                                                                                  ...
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-text">
                                                                                          <p style="font-size: 17px;">Criação de usuário de acesso</p>
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-spacer es-p20" style="font-size:0">
                                                                                  ...
                                                                                  <tr>
                                                                                      <td class="esd-block-text es-p20t" align="left">
                                                                                          <p>Caro(a) ${name}, seu usuário na plataforma Themis foi criado e já está disponível para uso neste momento! Você já pode utilizar as ferramentas da plataforma para deixar o complicado mais simples, como por exemplo:</p>
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td align="left" class="esd-block-text es-p20t es-p20b">
                                                                                          <ul>
                                                                                              ...
                                                                                              <li>Gestão de atividades em agenda</li>
                                                                                              <li>Administração de processos e observações</li>
                                                                                          </ul>
                                                                                      </td>
                                                                                  </tr>
                                                                              </tbody>
